...
?>
    <a href="<?php echo esc_url(home_url('/')); ?>"><img class="image_logo img-responsive left_logo" src="<?php echo $nimbus_image_logo; ?>" alt="<?php echo get_bloginfo('name', 'display'); ?>" /></a>
<?php
}
echo "</div>";
?>